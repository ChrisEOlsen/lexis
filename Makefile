...
CORE_SRCS := src/core/paths.c src/core/tokenizer.c src/core/stopwords.c src/core/pg_store.c src/core/bm25.c src/core/ingest.c src/core/local_llm_client.c src/core/vendor/cJSON.c src/core/wordnet.c src/core/synonym_table.c src/core/reranker.c src/core/query_formulation.c src/core/retrieval.c src/core/string_builder.c src/core/generation.c src/core/lemmatizer.c src/core/query_log.c src/core/config.c src/core/bulk_ingest.c src/core/eval.c src/core/csv_parse.c src/core/tool_router.c src/core/corpus_summary.c
